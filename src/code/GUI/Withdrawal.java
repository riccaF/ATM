...
public class Withdrawal extends Transaction {
    ...
    public void execute() {
        ...
        do {
            ...
            if (!amount.ugualeA(new Euro(CANCELED, 0))) {
                // get available balance of account involved
                // obtain a chosen withdrawal amount from the user
                  Euro chosenAmount = displayMenuOfAmounts();
                  availableBalance = new Euro(chosenAmount.getValore()); // convert to Euro and assign to amount
                ...
                if (amount.minoreDi(availableBalance)) {
                    ...
                    if (cashDispenser.isSufficientCashAvailable(amount)) {
                        ...
                        screen.displayMessageLine(
                                "\nPlease take your cash now in the amount of " + amount.stampa() + ".");
            ...
            } else // user chose cancel menu option
            {
                ...
                return; // return to the main menu because the user canceled
            }
        } while (!cashDispensed);
    } // end method execute
    ...
    private Euro displayMenuOfAmounts() {
        Euro userChoice = new Euro(0, 0); // local variable to store return value

        Screen screen = getScreen(); // get screen reference

        // array of amounts to correspond to menu numbers
        Euro amounts[] = {new Euro(0, 0), new Euro(20, 0), new Euro(40, 0), new Euro(60, 0), new Euro(100, 0), new Euro(200, 0)};

        // loop while no valid choice has been made
        while (userChoice.ugualeA(new Euro(0, 0))) {
            // display the menu
            screen.displayMessageLine("\nWithdrawal Menu:");
            ...
            switch (input) {
                ...
                case CANCELED: // the user chose to cancel
                    userChoice = new Euro(CANCELED, 0); // save user's choice
                    break;
