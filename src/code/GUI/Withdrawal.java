...
public class Withdrawal extends Transaction {
   private int amount; // amount to withdraw, lo lasciamo int perché è una scelta dell'utente, non un
                       // valore calcolato (ad esempio tra valori predefiniti, venti euro, cinquanta
                       // euro, ecc)
   ...
   public void execute() {
      ...
      Euro availableBalance; // amount available for withdrawal, lo cambiamo ad euro
      ...
      do {
         ...
         if (amount != CANCELED) {
            ...
            if (new Euro((double) amount).minoreDi(availableBalance) == true) {
               // check whether the cash dispenser has enough money
               if (cashDispenser.isSufficientCashAvailable(amount)) {
                  // update the account involved to reflect withdrawal
                  bankDatabase.debit(getAccountNumber(), new Euro((double) amount));
