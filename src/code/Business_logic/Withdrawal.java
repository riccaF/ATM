...
public class Withdrawal extends Transaction {
  ...
  private final static int CANCELED = 6; // constant for cancel option
  ...
  public void execute() {
    ...
    do {
      ...
      // System.out.println("amount.getValore() = " + amount.stampa());
  ...
  private Euro displayMenuOfAmounts() {
    ...
    return new Euro((double) userChoice); // return withdrawal amount or CANCELED
